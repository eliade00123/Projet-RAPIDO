...
<body class="background-image-full">
    ...
    <section>
        <div class="container">
            <h2 class="text-light">NOS COURSES </h2>
            <table class="tables">
                <thead>
                    <tr>
                        <td>N° de course</td>
                ...
                <tbody>
                    <?php
                    try{
                        $req = $connexion->prepare("SELECT * FROM courses WHERE status='En cours' XOR status='Terminée'");
                        $req->execute();
            ...
            <div class="lien">
                <a href="termine.php" class="text-warning">Terminer une course</a>
            </div>
        </div>
    </section>
